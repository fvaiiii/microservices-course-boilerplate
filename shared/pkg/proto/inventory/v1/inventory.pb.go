...
const (
	...
	PartType_PART_TYPE_WEAPON      PartType = 4 // TODO: Добавить остальные типы деталей из описания задания
)
...
type Part struct {
	...
	// TODO: Добавить остальные поля из описания задания
...
// TODO: Реализовать GetPartResponse
...
// TODO: Реализовать ListPartsRequest
...
// TODO: Реализовать ListPartsResponse
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseB_Z]github.com/fvaiiii/microservices-course-boilerplate/shared/pkg/proto/inventory/v1;inventoryv1b\x06proto3"
