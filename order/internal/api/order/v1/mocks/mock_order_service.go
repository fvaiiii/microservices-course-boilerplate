...
func (_mock *OrderService) Create(ctx context.Context, in input.CreateOrderInput) (model.Order, error) {
...
func (_e *OrderService_Expecter) Create(ctx interface{}, in interface{}) *OrderService_Create_Call {
	return &OrderService_Create_Call{Call: _e.mock.On("Create", ctx, in)}
}

func (_c *OrderService_Create_Call) Run(run func(ctx context.Context, in input.CreateOrderInput)) *OrderService_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 context.Context
		if args[0] != nil {
			arg0 = args[0].(context.Context)
...
func (_c *OrderService_Create_Call) RunAndReturn(run func(ctx context.Context, in input.CreateOrderInput) (model.Order, error)) *OrderService_Create_Call {
	_c.Call.Return(run)
	return _c
}
